...
int16_t _width=160;			///< Display width as modified by current rotation
int16_t _height=128;		///< Display height as modified by current rotation
uint8_t rotation = 1;		///< Display rotation (0 thru 3)

void drawPixel(int16_t x, int16_t y, uint16_t color)
{
	//ST7735_DrawPixel(x, y, color);
	hsp_tft18_draw_pixel(x, y, color);
}

void fillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color)
{
	//ST7735_FillRectangle(x, y, w, h, color);
	hsp_tft18_draw_block(x, y, w, h, color);
}
