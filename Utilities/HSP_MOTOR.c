...
#define CH1_LOWER_LIMIT	1220U
#define CH1_UPPER_LIMIT	1780U
#define CH2_LOWER_LIMIT	1220U
#define CH2_UPPER_LIMIT	1780U
...
#define MOTOR_DC_LIMIT	30

// pulse_width: value in unit of microsecond
// pulse_width maximum range: 500 ~ 2500
